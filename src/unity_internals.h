...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message)                           if (UnityAssertEqualNumber((_U_UINT)(_UU8 )(expected), (_U_UINT)(_UU8 )(actual), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT) != 0) return;
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message)                          if (UnityAssertEqualNumber((_U_UINT)(_UU16)(expected), (_U_UINT)(_UU16)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT) != 0) return;
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message)                          if (UnityAssertEqualNumber((_U_UINT)(_UU32)(expected), (_U_UINT)(_UU32)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT) != 0) return;
